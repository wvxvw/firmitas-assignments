...
\usepackage{./_build/latex/sphinx}
...
\begin{fulllineitems}
  \phantomsection\label{index:primes.factors}\pysiglinewithargsret{\code{primes.}\bfcode{factors}}{\emph{n}}{}
  Generates all prime factors of n.

\end{fulllineitems}

\index{is\_next\_prime() (in module primes)}

\begin{fulllineitems}
  \phantomsection\label{index:primes.is_next_prime}\pysiglinewithargsret{\code{primes.}\bfcode{is\_next\_prime}}{\emph{n}, \emph{sieve}}{}
  Tests whether n is prime.  Sieve should contain all primes less than n.

\end{fulllineitems}

\index{next\_prime() (in module primes)}

\begin{fulllineitems}
  \phantomsection\label{index:primes.next_prime}\pysiglinewithargsret{\code{primes.}\bfcode{next\_prime}}{\emph{sieve}}{}
...
\index{odd\_composite() (in module primes)}

\begin{fulllineitems}
  \phantomsection\label{index:primes.odd_composite}\pysiglinewithargsret{\code{primes.}\bfcode{odd\_composite}}{}{}
  Iterator.  Generates odd composite numbers.

\end{fulllineitems}

\index{primes() (in module primes)}

\begin{fulllineitems}
  \phantomsection\label{index:primes.primes}\pysiglinewithargsret{\code{primes.}\bfcode{primes}}{\emph{n=None}}{}
  Iterator.  Generates primes.

\end{fulllineitems}

\index{primes\_seq() (in module primes)}

\begin{fulllineitems}
  \phantomsection\label{index:primes.primes_seq}\pysiglinewithargsret{\code{primes.}\bfcode{primes\_seq}}{\emph{n}}{}
  Generates a sequence of primes up to n.

\end{fulllineitems}

\phantomsection\label{index:module-combinatorics}\index{combinatorics (module)}\index{digits() (in module combinatorics)}

\begin{fulllineitems}
  \phantomsection\label{index:combinatorics.digits}\pysiglinewithargsret{\code{combinatorics.}\bfcode{digits}}{\emph{n}}{}
  The digits of the argument, not counting the sign.

\end{fulllineitems}

\index{fib() (in module combinatorics)}

\begin{fulllineitems}
  \phantomsection\label{index:combinatorics.fib}\pysiglinewithargsret{\code{combinatorics.}\bfcode{fib}}{\emph{n}}{}
...
\index{has\_square() (in module combinatorics)}

\begin{fulllineitems}
  \phantomsection\label{index:combinatorics.has_square}\pysiglinewithargsret{\code{combinatorics.}\bfcode{has\_square}}{\emph{n}}{}
  Returns True iff n contains a perfect square as a factor.

\end{fulllineitems}

\index{nub() (in module combinatorics)}

\begin{fulllineitems}
  \phantomsection\label{index:combinatorics.nub}\pysiglinewithargsret{\code{combinatorics.}\bfcode{nub}}{\emph{nums}}{}
  Returns a copy of nums with duplicates removed.  The numbers
  in nums will be solrted in increasing order.

\end{fulllineitems}

\phantomsection\label{index:module-cards}\index{cards (module)}
\end{document}